...
// in simulator we redefine to format for harmonyShed Developer console
...
{\
	NSString * exceptionName = [@"org.harmonyshed." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.harmonyshed";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIharmonyShedNativeItemNone = -1, 
	UIharmonyShedNativeItemSpinner = -2,
	UIharmonyShedNativeItemProgressBar = -3,
	
	UIharmonyShedNativeItemSlider = -4,
	UIharmonyShedNativeItemSwitch = -5,
	UIharmonyShedNativeItemMultiButton = -6,
	UIharmonyShedNativeItemSegmented = -7,
	
	UIharmonyShedNativeItemTextView = -8,
	UIharmonyShedNativeItemTextField = -9,
	UIharmonyShedNativeItemSearchBar = -10,
	
	UIharmonyShedNativeItemPicker = -11,
	UIharmonyShedNativeItemDatePicker = -12,
	
	UIharmonyShedNativeItemInfoLight = -13,
	UIharmonyShedNativeItemInfoDark = -14,
	
	UIharmonyShedNativeItemDisclosure = -15,
	
	UIharmonyShedNativeItemContactAdd = -16
};
